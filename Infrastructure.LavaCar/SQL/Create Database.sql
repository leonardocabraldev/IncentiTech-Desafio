...
(4, 'André Ferreira', DATEADD(DAY, 1, DATEADD(HOUR, 2, GETDATE())), 1, GETDATE(), GETDATE(), 'Fernando'),
(5, 'Beatriz Rocha', DATEADD(DAY, 1, DATEADD(HOUR, 4, GETDATE())), 1, GETDATE(), GETDATE(), 'Fernando'),
(6, 'Fernanda Alves', DATEADD(DAY, 2, DATEADD(HOUR, 3, GETDATE())), 1, GETDATE(), GETDATE(), 'Leonardo'),
(7, 'Ricardo Mendes', DATEADD(DAY, 2, DATEADD(HOUR, 5, GETDATE())), 1, GETDATE(), GETDATE(), 'Fernando'),
(8, 'Paulo Matos', DATEADD(DAY, 3, DATEADD(HOUR, 2, GETDATE())), 1, GETDATE(), GETDATE(), 'Leonardo'),
(9, 'Sabrina Nunes', DATEADD(DAY, 3, DATEADD(HOUR, 6, GETDATE())), 1, GETDATE(), GETDATE(), 'Fernando'),
